...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BLS2ReUC.mjs");
...
var manifest = {
	"2b2261cff88357137235722bf39631b75347a2a278a6df81933e4be9c436948b": {
		functionName: "generateNotes_createServerFn_handler",
		importer: () => import("./ai-By_sCF0I.mjs")
	},
	"dd12aa1ad34f002e7de23905c12362de06596f34906b15014a03da01f6397e9b": {
		functionName: "generateAssist_createServerFn_handler",
		importer: () => import("./ai-By_sCF0I.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BwvKYRlp.mjs").then((n) => n.t),
